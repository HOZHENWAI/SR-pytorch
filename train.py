...
train_instance.train(parameters.batch_size,
    parameters.epochs, parameters.lrate, (parameters.n_channels,lowres_size[0],lowres_size[1]), device, 'PSNR', tensorboard = False)
    # low res size is redundant, try to find some way to pass information through the downsampler
